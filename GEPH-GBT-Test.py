...
"""
Compute the generalized extended persistent homology
"""
...
def compute_interaction_feature_matrix(point1, point2, filtration_value): 
    ...
    for key, point in point_cloud.items():
        ...
        if (num[0]==0) or (num[1]==0):
            ...
            persistence = read_persistence_interval(persistence_index=persistence_index, simplex=simplicial_complex,filtration=filter_value)
